...
class JobController extends AbstractController
{
     ...
     * @Route("/", name="job.list")
     */
    public function list(EntityManagerInterface $em, JobHistoryService $jobHistoryService)
    {
     ...
     */
    public function show(Job $job, JobHistoryService $jobHistoryService)
    {
...
//            }
     ...
     */
    public function edit(Request $request, Job $job, EntityManagerInterface $em)
    {
        $form = $this->createForm(JobType::class, $job);
        $form->handleRequest($request);
    ...
    /**
     * @param Job $job
     * @Route("/job/{token}", name="job.preview", methods={"GET", "POST"}, requirements={"token"="\w+"})
     * @return Response
     */
     ...
     */
    public function delete(Request $request, Job $job, EntityManagerInterface $em){
